...
function datePickerBuildCalendar(datePicker) {
	...
	calendarElement.appendChild(calendarContainerElement)
...
function datePickerOpenCalendar(datePicker) {
	...
	datePicker.calendar.classList.add("js-date-picker-mobile-animation-in-out")
...
function datePickerCloseCalendar(datePicker) {
	datePicker.calendar.classList.remove("js-date-picker-mobile-animation-in-out")
...
function datePickerUpdateValues(datePicker) {
	...
	var value = datePicker.startDayElement.date.format("m/d/yy") + " - " + datePicker.endDayElement.date.format("m/d/yy")

	if(datePicker.startDayElement == datePicker.endDayElement) {
		value = datePicker.startDayElement.date.format("m/d/yy")
	}
